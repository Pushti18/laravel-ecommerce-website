...
<title>Shopping</title>
 <link rel="icon" type="image/x-icon" href="public/frontend/images/cart.png">
<meta charset="utf-8">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-2 col-sm-3 col-3 order-1">
                        <div class="logo_container">
                            <div class="logo"><a href="{{url('/')}}"><img src="{{ asset('public/frontend/images/shopping_cart.jpg')}}" alt=""></a></div>
                        </div>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 footer_col">
                    <div class="footer_column footer_contact">
                        ...
                        <div class="footer_title">For Question? Call Us 24/7</div>
